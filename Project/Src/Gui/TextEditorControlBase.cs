...
namespace ICSharpCode.TextEditor
{
	...
	public abstract class TextEditorControlBase : UserControl
	{
		...
		{
			get { return _document.TextEditorProperties; }
			set
			{
		...
		/// </value>
		[Browsable(false)]
		public bool IsInUpdate => _updateLevel > 0;
			...
			if (Document.HighlightingStrategy != null)
			{
				try
				{
					Document.HighlightingStrategy =
						HighlightingStrategyFactory.CreateHighlightingStrategy(Document.HighlightingStrategy.Name);
				}
		...
		{
			if (_encoding == null || FileReader.IsUnicode(_encoding))
				return true;
			// not a unicode codepage
			var text = _document.TextContent;
		...
		{
			get { return _document.TextEditorProperties.ShowSpaces; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.TextRenderingHint; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowTabs; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowEolMarker; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowHorizontalRuler; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowVerticalRuler; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.VerticalRulerRow; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowLineNumbers; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowInvalidLines; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.EnableFolding; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ShowMatchingBracket; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.IsIconBarVisible; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.TabIndent; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.LineViewerStyle; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.IndentStyle; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.ConvertTabsToSpaces; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.HideMouseCursor; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.AllowCaretBeyondEol; }
			set
			{
		...
		{
			get { return _document.TextEditorProperties.BracketMatchingStyle; }
			set
			{
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
		[Description(
			"The base font of the text area. No bold or italic fonts can be used because bold/italic is reserved for highlighting purposes."
		)]
		public override Font Font
		{
			get { return _document.TextEditorProperties.Font; }
			set
			{
