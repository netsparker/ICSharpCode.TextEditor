	...
	public class DefaultFormattingStrategy : IFormattingStrategy
	{
		...
		public int IndentLine(TextArea textArea, int line)
		{
			...
			switch (textArea.Document.TextEditorProperties.IndentStyle)
			{
				...
				case IndentStyle.Smart:
					...
					break;
				default:
					throw new NotSupportedException("Unsupported value for IndentStyle: " +
					                                textArea.Document.TextEditorProperties.IndentStyle);
			}
		...
		public static void SmartReplaceLine(IDocument document, LineSegment line, string newLineText)
		{
			...
			if (oldLineText == newLineText)
				return;
			var pos = oldLineText.IndexOf(newLineTextTrim);
			if (newLineTextTrim.Length > 0 && pos >= 0)
			{
				...
				try
				{
					...
					document.Replace(lineOffset + pos + newLineTextTrim.Length, line.Length - pos - newLineTextTrim.Length,
