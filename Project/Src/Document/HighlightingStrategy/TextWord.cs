	...
	public class TextWord
	{
		...
		public string Word
		{
			get
			{
				if (_document == null)
					return string.Empty;
				return _document.GetText(_line.Offset + Offset, Length);
			}
		}
...
#endif
			var after = new TextWord(word._document, word._line, word.Offset + pos, word.Length - pos, word._color,
				word.HasDefaultColor);
			word = new TextWord(word._document, word._line, word.Offset, pos, word._color, word.HasDefaultColor);
			return after;
		}
